    ...
    <Layout>
      ...
      <section className="relative overflow-hidden -mx-4 px-4 pt-8 pb-6 sm:pt-12 sm:pb-8 mb-8 bg-linear-to-br from-parchment via-parchment to-gold/10">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          {isLoading ? (
            <p className="text-ink/60 text-sm">読み込み中…</p>
          ) : isAuthenticated ? (
      ...
      <section className="max-w-5xl mx-auto mb-12">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-4">
          {HOW_IT_WORKS.map((item) => (
            <div
              key={item.step}
              className="relative p-3 sm:p-5 bg-parchment border border-gold/40 rounded-xl shadow-sm hover:shadow-md transition"
            >
      ...
      <section className="max-w-4xl mx-auto mb-12 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div
              key={f.title}
              className="p-5 bg-parchment/60 border border-gold/30 rounded-xl text-center hover:border-seal hover:shadow-sm transition"
            >
